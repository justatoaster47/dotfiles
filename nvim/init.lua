...
--getting rid of those blank prefixes
...
vim.keymap.set("v", "J", ":m '>+1<CR>gv=gv") --move highlighted lines 
vim.keymap.set("v", "K", ":m '<-2<CR>gv=gv") --move highlighted lines 
...
vim.keymap.set("n", "J", "<C-d>zz") --half page jumps
...
vim.keymap.set("n", "<leader>c", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], {desc = 'search & replace'})
vim.keymap.set("n", "<leader>l", [[/<C-r><C-w>]], {desc = 'search & replace'})
vim.keymap.set("n", "<leader>x", "<cmd>!chmod +x %<CR>", { silent = true })
--vim.keymap.set("n", "<leader><leader>", function()
--    vim.cmd("so")
--end)

--vim.keymap.set('n', '<leader>sr', require('telescope.builtin').oldfiles, { desc = '[S]earch [R]esume ' })
...
--vim.keymap.set('n', 'gd', require('telescope.builtin').lsp_references, {desc = '[S]earch [R]eferences'})
end
